...
class _ProfileState extends State<Profile> {
  ...
  List items = [
    ...
    },
    {
      ...
      "title": "YouTube",
      // VoidCallback: launch("https://instagram.com"),
    },
    {
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                if (items[index]['title'] == 'YouTube') {
                  return ListTile(
                    ...
                    onTap: () {
                      launch(
                          "https://youtube.com/channel/UC-gsei6VwF97jzQ2ttAcNPw");
                    },
                    title: Text(items[index]['title']),
                  );
                }
                if (items[index]['title'] == 'Twitter') {
                  return ListTile(
                    leading: Icon(
                      items[index]['icon'],
                    ),
                    onTap: () {
                      launch("https://twitter.com/hubwhale");
                    },
                    title: Text(items[index]['title']),
                  );
                }
